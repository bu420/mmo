...
typedef enum mmo_player_state_e {
    MMO_PLAYER_STATE_LOGIN,
    MMO_PLAYER_STATE_FISHING
} mmo_player_state_t;
...
void mmo_player_update(mmo_player_t *player, mmo_game_t *game, mmo_server_t *server,
                       mmo_char_arr_t *in);
