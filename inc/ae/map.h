...
#define ae_map_new_reserve(M, N, HASH, EQ)                                    \
    do {                                                                      \
        ...
        ae_generic_assign(M.states, calloc(N, sizeof(ae_map_entry_state_t))); \
                                                                              \
        M.len = 0;                                                            \
        M.cap = N;                                                            \
                                                                              \
...
#define ae_map_set(M, K, V)                                                   \
    do {                                                                      \
        if (M.len == M.cap / 2) {                                             \
            ...
            M.cap *= 2;                                                       \
                                                                              \
            ae_generic_assign(M.keys, calloc(M.cap, sizeof(M.keys[0])));      \
            ae_generic_assign(M.vals, calloc(M.cap, sizeof(M.vals[0])));      \
