...
void mmo_str_get_next_token(const mmo_char_arr_t *text,
                            const mmo_char_arr_t *prev, mmo_char_arr_t *out);

/* Splits a string into a linked list of string "views". */
void mmo_str_split(const mmo_char_arr_t *text, char delimiter,
...
void mmo_str_justify_and_hyphenate(const mmo_char_arr_t *in, int width,
